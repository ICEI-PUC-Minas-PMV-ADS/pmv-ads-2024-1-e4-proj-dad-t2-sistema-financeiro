...
using CategoriaMicroservice.Models; // Certifique-se de que esta linha está presente
...
var port = Environment.GetEnvironmentVariable("PORT") ?? "5001"; // Você pode alterar a porta aqui
