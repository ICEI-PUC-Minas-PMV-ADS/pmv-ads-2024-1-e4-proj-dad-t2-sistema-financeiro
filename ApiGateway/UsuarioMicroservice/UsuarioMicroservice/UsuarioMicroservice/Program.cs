...
using UsuarioMicroservice.Models; // Certifique-se de que esta linha está presente
...
// Configurar serviços
builder.Services.Configure<UsuarioDataBaseSettings>(builder.Configuration.GetSection("ConnectionStrings"));
